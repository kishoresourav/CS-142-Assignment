	   ...
	   elements in the linked list.
		...
		// Member functions of the SLList class.
		  ...
		  void display();
																						        	   ...
																						        	   void SLList::insert(int d){ 		                                                            // Inserts the value stored in d at the end of the list.
...
*/
       ...
       return p;
												 ...
												 /*
											         * Inserts a node with data value d at the ith position of the list. Returns -1 for an invalid value  												    * Returns 0 for successful insertion of the node at the correct position.
*/
       ...
       if (i == size+1) {			// insert function is called when the
	       ...
	       Node* p = getNode(i-1);	// p is a placeholder variable which holds a pointer to the (i-1)th element.
